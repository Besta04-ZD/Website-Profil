<?php
    ...
    $querySekitar = mysqli_query($con, "SELECT * FROM fasilitas");
        ...
        <div class="my-5 col-12 col-md-6">
            <h3>Tambah Fasilitas</h3>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" id="fasilitas" name="fasilitas" class="form-control" autocomplete="off"
                        required>
                    </div>
                    <div class="mb-3">
            ...
            ?>
                ...
                <?php
                        ...
                        $queryTambah = mysqli_query($con, "INSERT INTO  fasilitas (fasilitas, foto, detail) 
                        VALUES ('$nama', '$new_name', '$detail')");

                        if($queryTambah){
                ?>
                            <div class="alert alert-primary" role="alert">
                            Data Fasilitas Tersimpan
                            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="fasilitas-detail.php?p=<?php echo $data['id']; ?>" 
